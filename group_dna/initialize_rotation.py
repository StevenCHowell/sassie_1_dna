...
if __name__ == '__main__':
    ...
    dihedral_parameters, flexible_residues, residue_rotation_indices, residue_rotation_mask, step_parameters, first_last_resid = initialize_system(
        m1, molecule_type, basis, numranges, numcont)
