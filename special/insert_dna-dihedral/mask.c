...
void get_mask_array(long long *aptr, int nflexible, int natoms, char **name, long long *resid,long long *flexible_residues,int nresidues, int mtype){
	...
	int i, j, q0, fr, value, count, purine;
	...
	if(mtype == 0) {
		...
		for(fr=0 ; fr<nflexible ; fr++){
			...
			for(i=0 ; i<natoms ; i++){
				if (resid[i] == q0){
				        // Check if residue q0 is a purine (purines have an N9 atom prymadines do not)
					if((strcmp(name[i],"N9")==0)){
					        purine = 1;	
						break;
					}
				}
			...
			for(i=0 ; i<natoms ; i++){
				...
				else if(resid[i] == q0 && (strcmp(name[i],"O4'")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
				else if(resid[i] == q0 && (strcmp(name[i],"C1'")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
				else if(resid[i] == q0 && purine == 0 && (strcmp(name[i],"N1")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
				else if(resid[i] == q0 && purine == 0 && (strcmp(name[i],"C2")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
				else if(resid[i] == q0 && purine == 1 && (strcmp(name[i],"N9")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
				else if(resid[i] == q0 && purine == 1 && (strcmp(name[i],"C4")==0)){
					value=1 ; 
					count++;
					value_array[i]=value ;
				}
