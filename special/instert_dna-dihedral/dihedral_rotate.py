...
import sassie.simulate.monte_carlo.monomer.vdw_overlap as vdw_overlap
        ...
        if(molecule_type == 'protein'):
                ...
                if(an=='phi'):
                        ...
                        if(q0 == first_last_resid[0]):
                                ...
                                angle=sasmath.dihedral_angle(lcoor[1,:],lcoor[2,:],lcoor[3,:],lcoor[4,:])
                else:
                        angle=0.0
...
#
                ...
                if(an == 'alpha'):
                        ...
                        if(q0 == first_last_resid[0]):
                                ...
                                angle=sasmath.dihedral_angle(lcoor[2,:],lcoor[3,:],lcoor[4,:],lcoor[5,:])
                elif(an == 'delta'):
                        if(q0 == first_last_resid[0]):
                                angle=sasmath.dihedral_angle(lcoor[2,:],lcoor[3,:],lcoor[4,:],lcoor[5,:])
                        else:
                                angle=sasmath.dihedral_angle(lcoor[3,:],lcoor[4,:],lcoor[5,:],lcoor[6,:])
                elif(an == 'epsilon'):
                        if(q0 == first_last_resid[0]):
                                angle=sasmath.dihedral_angle(lcoor[3,:],lcoor[4,:],lcoor[5,:],lcoor[6,:])
                        else:
                                angle=sasmath.dihedral_angle(lcoor[4,:],lcoor[5,:],lcoor[6,:],lcoor[7,:])
                elif(an == 'eta'):
                        if(q0 == first_last_resid[0]):
                                angle=sasmath.dihedral_angle(lcoor[4,:],lcoor[5,:],lcoor[6,:],lcoor[7,:])
                        else:
                                angle=sasmath.dihedral_angle(lcoor[5,:],lcoor[6,:],lcoor[7,:],lcoor[8,:])
                else:
                        angle=0.0
                ...
                if(an == 'alpha'):
                        if(q0 == first_last_resid[0]):
                                ...
                                angle=sasmath.dihedral_angle(lcoor[i["O3'-1"],:],lcoor[i["P"],:],lcoor[i["O5'"],:],lcoor[i["C5'"],:])
                elif(an == 'beta'):
                        angle=sasmath.dihedral_angle(lcoor[i["P"],:],lcoor[i["O5'"],:],lcoor[i["C5'"],:],lcoor[i["C4'"],:])
                elif(an == 'gamma'):
                        angle=sasmath.dihedral_angle(lcoor[i["O5'"],:],lcoor[i["C5'"],:],lcoor[i["C4'"],:],lcoor[i["C3'"],:])
                elif(an == 'delta'):
                        angle=sasmath.dihedral_angle(lcoor[i["C5'"],:],lcoor[i["C4'"],:],lcoor[i["C3'"],:],lcoor[i["O3'"],:])
                elif(an == 'epsilon'):
                        if(q0 == first_last_resid[1]):
                                angle=0
                        else:
                                angle=sasmath.dihedral_angle(lcoor[i["C4'"],:],lcoor[i["C3'"],:],lcoor[i["O3'"],:],lcoor[i["P+1"],:])
                elif(an == 'zeta'):
                        if(q0 == first_last_resid[1]):
                                angle=0
                        else:
                                angle=sasmath.dihedral_angle(lcoor[i["C3'"],:],lcoor[i["O3'"],:],lcoor[i["P+1"],:],lcoor[i["O5'+1"],:])
                elif(an == 'chi'):
                        angle=sasmath.dihedral_angle(lcoor[i["O4'"],:],lcoor[i["C1'"],:],lcoor[i["chi3"],:],lcoor[i["chi4"],:])
...
def rotate_dihedral(coor,m1,frame,q0,itheta,an,indices,this_mask,first_last_resid,molecule_type):
        ...
        if(molecule_type == 'protein'):
                ...
                if(an=='alpha'):
                        v[0]=o5p[0]-p1[0] ; v[1]=o5p[1]-p1[1] ; v[2]=o5p[2]-p1[2]	
                        tee[0][3]=p1[0] 
                        tee[1][3]=p1[1] 
                        tee[2][3]=p1[2]	
                        watch_value=indices[2]-1
                elif(an=='beta'):
                        v[0]=c5p[0]-o5p[0] ; v[1]=c5p[1]-o5p[1] ; v[2]=c5p[2]-o5p[2]	
                        tee[0][3]=o5p[0] 
                        tee[1][3]=o5p[1] 
                        tee[2][3]=o5p[2]	
                        if(q0 == first_last_resid[0]):
                        ...
                        v[0]=c4p[0]-c5p[0] ; v[1]=c4p[1]-c5p[1] ; v[2]=c4p[2]-c5p[2]	
                        tee[0][3]=c5p[0] 
                        tee[1][3]=c5p[1] 
                        tee[2][3]=c5p[2]	
                        if(q0 == first_last_resid[0]):
                        ...
                        v[0]=c3p[0]-c4p[0] ; v[1]=c3p[1]-c4p[1] ; v[2]=c3p[2]-c4p[2]	
                        tee[0][3]=c4p[0] 
                        tee[1][3]=c4p[1] 
                        tee[2][3]=c4p[2]	
                        if(q0 == first_last_resid[0]):
                        ...
                        v[0]=o3p[0]-c3p[0] ; v[1]=o3p[1]-c3p[1] ; v[2]=o3p[2]-c3p[2]	
                        tee[0][3]=c3p[0] 
                        tee[1][3]=c3p[1] 
                        tee[2][3]=c3p[2]	
                        if(q0 == first_last_resid[0]):
                        ...
                        v[0]=p2[0]-o3p[0] ; v[1]=p2[1]-o3p[1] ; v[2]=p2[2]-o3p[2]	
                        tee[0][3]=o3p[0] 
                        tee[1][3]=o3p[1] 
                        tee[2][3]=o3p[2]	
                        if(q0 == first_last_resid[0]):
...
def rotate(coor,m1,q0,th,an,cut,lowrg,highrg,re,taccepted,zflag,zval,cflag,dcdoutfile,indices,this_mask,basis_mask,sub_m2,align_mask,coor_sub_m1,com_sub_m1,mask_a_array,mask_b_array,distance_array,type_array,first_last_resid,molecule_type,cutoff_array,vdw_factor):
        ...
        result = rotate_dihedral(coor,m1,frame,q0,th,an,indices,this_mask,first_last_resid,molecule_type)

        if result == 1:
                error,basis_coor = m1.get_coor_using_mask(frame,basis_mask)

                if(len(cutoff_array) > 0):  
                        check = vdw_overlap.overlap(basis_coor[0],cutoff_array,vdw_factor)
                else:
