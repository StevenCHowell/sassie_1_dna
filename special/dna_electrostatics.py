...
#
# $Id: driven_dna_move.py 73 2014-10-14 20:30:02Z schowell $
#
...
def dna_mc_save_info(ARGS, cg_dna, aa_dna, cg_pro, aa_pro, vecXYZ, lp, trialbeads,
    ...
    while n_accept < ARGS.nsteps:
        ...
        if rg_pass and dna_pass and no_collision:
            ...
            coulomb.coulomb(cg_dna.coor(), charge, t, swtichd, nbcutoff)
