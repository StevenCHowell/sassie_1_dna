...
def plot_dna_dihedral_grid(all_angles):
    ...
    for frame in xrange(n_frames):
        ...
        plt.plot(all_angles[frame][0:-1,angles[x]],all_angles[frame][1:,angles[y]],'o')
        ...
        x = r'$\zeta$'
        y = r'$\epsilon$'
        plt.plot(all_angles[frame][:, angles[x]], all_angles[frame][:, angles[y]], 'o')
        plt.xlabel(x)
        plt.ylabel(y)
        plt_format()
        ...
        x = r'$\zeta$'
        y = r'$\zeta$'
        plt.plot(all_angles[frame][:-1, angles[x]], all_angles[frame][1:, angles[y]], 'o')
        plt.xlabel(x)
        plt.ylabel(y + ' + 1')
        plt_format()
...
def plot_dna_compare_dihedral(n0_all_angles, nm_all_angles, m__all_angles):
    ...
    x = 'zeta'
    y = 'alpha'
    ax1.scatter(n0_all_angles[angles[x]][0:-1],n0_all_angles[angles[y]][1:], c='b', marker='x', s=80)
    ax1.scatter(nm_all_angles[angles[x]][0:-1],nm_all_angles[angles[y]][1:], c='r', marker='o', s=25)
    ax1.scatter(m__all_angles[angles[x]][0:-1],m__all_angles[angles[y]][1:], c='g', marker='s', s=25)    
    ax1.set_xlabel(x)
    ax1.set_ylabel(y + ' + 1')
    grid_format(ax1)
    ...
    x = 'zeta'
    y = 'beta'
    ax2.scatter(n0_all_angles[angles[x]][0:-1], n0_all_angles[angles[y]][1:], c='b', marker='x', s=80)    
    ax2.scatter(nm_all_angles[angles[x]][0:-1], nm_all_angles[angles[y]][1:], c='r', marker='o', s=25)    
    ax2.scatter(m__all_angles[angles[x]][0:-1], m__all_angles[angles[y]][1:], c='g', marker='s', s=25)
    ax2.set_xlabel(x)
    ax2.set_ylabel(y + ' + 1')
    grid_format(ax2)
    ...
    x = 'zeta'
    y = 'epsilon'
    ax3.scatter(n0_all_angles[angles[x]],n0_all_angles[angles[y]], c='b', marker='x', s=80)    
    ax3.scatter(nm_all_angles[angles[x]],nm_all_angles[angles[y]], c='r', marker='o', s=25)    
    ax3.scatter(m__all_angles[angles[x]],m__all_angles[angles[y]], c='g', marker='s', s=25)    
    ax3.set_xlabel(x)
    ax3.set_ylabel(y)
    grid_format(ax3)    
    ...
    x = 'alpha'
    y = 'gamma'
    ax4.scatter(n0_all_angles[angles[x]],n0_all_angles[angles[y]], c='b', marker='x', s=80)
    ax4.scatter(nm_all_angles[angles[x]],nm_all_angles[angles[y]], c='r', marker='o', s=25)
    ax4.scatter(m__all_angles[angles[x]],m__all_angles[angles[y]], c='g', marker='s', s=25)
    ax4.set_xlabel(x)
    ax4.set_ylabel(y)
    grid_format(ax4)
    ...
    x = 'zeta'
    y = 'chi'
    ax5.scatter(n0_all_angles[angles[x]],n0_all_angles[angles[y]], c='b', marker='x', s=80)
    ax5.scatter(nm_all_angles[angles[x]],nm_all_angles[angles[y]], c='r', marker='o', s=25)
    ax5.scatter(m__all_angles[angles[x]],m__all_angles[angles[y]], c='g', marker='s', s=25)
    ax5.set_xlabel(x)
    ax5.set_ylabel(y)
    grid_format(ax5)
    ...
    x = 'delta'
    y = 'chi'
    ax6.scatter(n0_all_angles[angles[x]],n0_all_angles[angles[y]], c='b', marker='x', s=80)
    ax6.scatter(nm_all_angles[angles[x]],nm_all_angles[angles[y]], c='r', marker='o', s=25)
    ax6.scatter(m__all_angles[angles[x]],m__all_angles[angles[y]], c='g', marker='s', s=25)
    ax6.set_xlabel(x)
    ax6.set_ylabel(y)
    grid_format(ax6)    
    ...
    x = 'zeta'
    y = 'zeta'
    ax7.scatter(n0_all_angles[angles[x]][:-1],n0_all_angles[angles[y]][1:], c='b', marker='x', s=80)
    ax7.scatter(nm_all_angles[angles[x]][:-1],nm_all_angles[angles[y]][1:], c='r', marker='o', s=25)
    ax7.scatter(m__all_angles[angles[x]][:-1],m__all_angles[angles[y]][1:], c='g', marker='s', s=25)
    ax7.set_xlabel(x)
    ax7.set_ylabel(y + ' + 1')
    grid_format(ax7)
    ...
    x = 'epsilon'
    y = 'epsilon'
    ax8.scatter(n0_all_angles[angles[x]][:-1],n0_all_angles[angles[y]][1:], c='b', marker='x', s=80, label="starting")
    ax8.scatter(nm_all_angles[angles[x]][:-1],nm_all_angles[angles[y]][1:], c='r', marker='o', s=25, label="final")
    ax8.scatter(m__all_angles[angles[x]][:-1],m__all_angles[angles[y]][1:], c='g', marker='s', s=25, label="minimized")
    ax8.set_xlabel(x)
    ax8.set_ylabel(y + ' + 1')
    grid_format(ax8)
...
def plot_dna_dihedral(min_angles):
    ...
    # for frame in xrange(n_frames):       
        ...
        plt_format()
        plt.tick_params(labelleft='off')
        plt.legend(['min','raw'], loc='upper left', bbox_to_anchor=[1.1475, 1.07], numpoints = 1)
...
def get_angles(dcd_file_name, pdb_file_name, first_last_resid, flex_file, nf=0):
    ...
    for i in xrange(nf):
        ...
        for res in xrange(n_cont[0]):
            q0 = res_low[0]+res
            error, res_mask = mol.get_subset_mask("(resid[i] == "+str(q0)+")")
