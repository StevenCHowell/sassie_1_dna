...
C
        subroutine coulomb(coor,charge,t,natoms)
      
        integer natoms,i,j
        double precision coor(natoms,3) 
        double precision charge(natoms1)
        double precision t
C        double precision vdwp1(natoms1,2)
C        double precision vdwp2(natoms2,2)
...
cf2py intent(in) :: coor,charge,t,natoms,switchd,nbcutoff,er,slength
...
C       conversion to unitless energy
