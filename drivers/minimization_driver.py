...
def parse():
    ...
    # standard input
    parser.add_argument(
        "-r", "--runname", type=str, help=("folder to store the minimization results"))
    parser.add_argument("-i", "--infile", type=str,
                        help=("dcd/pdb file that contains the structure/s to minimize"))
    parser.add_argument("-p", "--pdbfile", type=str,
                        help=("pdb file containing the structure info (enables using dcd files)"))
    parser.add_argument("-o", "--outfile", type=str,
                        help=("name for output dcd file containing all the minimized structures"))
    parser.add_argument("-psf", "--psffile", type=str,
                        help=("charmm psf file containing force info for molecular bonds"))

    # default usually sufficient
    parser.add_argument("--parmfile", type=str, default='/usr/local/bin/toppar/par_all27_prot_na.inp',
                        help=("topology file containing molecule info"))
    parser.add_argument(
        "--nsteps", type=str, default='2000', help=("number of minimization steps"))
    ...
    parser.add_argument(
        "--temperature", type=str, default='300.0', help=("temperature"))
